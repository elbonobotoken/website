...
function LandingPage2() {
  return (
    <div className="main-block">
      ...
      <section>
        <div className="s2-bonobo-content-card col-md-7 float-left">
          <div className="content">
            <strong>WHY</strong>
            ...
            <ul>
              ...
              <li>
                <span>.</span>A professional and talented team committed to
      ...
      <div className="section-12">
        <div className="main">
          <div className="s12-bonobo-content-card col-8 float-left">
          ...
          <div className="s12-vector-block col-4 nopadding float-left">
